 ...
 *
 * Permutation : a way, especially one of several possible variations, in which
...
public class Solution2 {
    ...
    public static boolean permutation(String s, String t) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            letters[s.charAt(i)]++; // Set char-index values to 1
        }

        for (int i = 0; i < t.length(); i++) {
            letters[t.charAt(i)]--; // Set char-index values to 0 or -1
    ...
    public static void main(String[] args) {
        ...
        {"orange", "rgenao"}, {"hello", "bammn"}, {"hut", "hop"}, {"u", "p"}};
